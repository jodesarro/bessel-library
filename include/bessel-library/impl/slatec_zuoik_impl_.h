/* 
    ...
    File: include/bessel-library/impl/slatec_zuoik_impl_.h
    ...
    Description:
        Slatec's ZUOIK subroutine, originally translated from Fortran to C
...
/* ----------------------------------------------------------------------- */
    ...
    init = 0;
    slatec_zunik_impl_(&zrr, &zri, &gnu, ikflg, &c_u_1, tol, &init, &phir, &phii, &zeta1r, 
...
L30:
    ...
    znr = -znr;
L40:
    slatec_zunhj_impl_(&znr, &zni, &gnu, &c_u_1, tol, &phir, &phii, &argr, &argi, &zeta1r, 
