/*
  ...
  File: include/bessel-library/impl/slatec_zbesi_impl_.h
  Language standards: C99
  References: include/bessel-library/references.txt
  License: include/bessel-library/license.txt
  Repository: <https://github.com/jodesarro/bessel-library>

  Description: Slatec's ZBESI subroutine, originally translated from Fortran to
  C with f2c, and adapted.
*/

#ifndef BESSEL_LIBRARY_SLATEC_ZBESI_IMPL_H
#define BESSEL_LIBRARY_SLATEC_ZBESI_IMPL_H
...
/* DECK ZBESI */
/* Subroutine */
static inline int slatec_zbesi_impl_(double *zr, double *zi, double *fnu,
  ...
  *nz = 0;
  ...
  csgni = -csgni;
L40:
  slatec_zbinu_impl_(&znr, &zni, fnu, kode, n, &cyr[1], &cyi[1], nz, &rl, &fnul,
                     &tol, &elim, &alim);
  if (*nz < 0) {
    goto L120;
  }
...
#endif /* BESSEL_LIBRARY_SLATEC_ZBESI_IMPL_H */