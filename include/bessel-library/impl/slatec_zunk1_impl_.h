/* 
    ...
    File: include/bessel-library/impl/slatec_zunk1_impl_.h
    ...
    Description:
        Slatec's ZUNK1 subroutine, originally translated from Fortran to C
...
/* ----------------------------------------------------------------------- */
	...
	fn = *fnu + (i_u_ - 1);
	init[j - 1] = 0;
	slatec_zunik_impl_(&zrr, &zri, &fn, &c_u_2, &c_u_0, tol, &init[j - 1], &phir[j - 1],
...
/* ----------------------------------------------------------------------- */
    ...
    initd = 0;
    slatec_zunik_impl_(&zrr, &zri, &fn, &c_u_2, &ipard, tol, &initd, &phidr, &phidi, &
...
L175:
	...
	initd = 0;
L180:
	slatec_zunik_impl_(&zrr, &zri, &fn, &c_u_1, &c_u_0, tol, &initd, &phidr, &phidi, &
