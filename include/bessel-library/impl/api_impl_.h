...
#if defined(BESSEL_LIBRARY_EXPORTS_IMPL_) || defined(BESSEL_LIBRARY_IMPORTS)
#define BESSEL_LIBRARY_API_IMPL_                                               \
  BESSEL_LIBRARY_CPP_IMPL_ BESSEL_LIBRARY_VISIBILITY_IMPL_
#else
#define BESSEL_LIBRARY_API_IMPL_ BESSEL_LIBRARY_VISIBILITY_IMPL_
#endif
