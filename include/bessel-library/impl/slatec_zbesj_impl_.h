/*
  ...
  File: include/bessel-library/impl/slatec_zbesj_impl_.h
  Language standards: C99
  References: include/bessel-library/references.txt
  License: include/bessel-library/license.txt
  Repository: <https://github.com/jodesarro/bessel-library>

  Description: Slatec's ZBESJ subroutine, originally translated from Fortran to
  C with f2c, and adapted.
*/

#ifndef BESSEL_LIBRARY_SLATEC_ZBESJ_IMPL_H
#define BESSEL_LIBRARY_SLATEC_ZBESJ_IMPL_H
...
/* DECK ZBESJ */
/* Subroutine */
static inline int slatec_zbesj_impl_(double *zr, double *zi, double *fnu,
...
#endif /* BESSEL_LIBRARY_SLATEC_ZBESJ_IMPL_H */