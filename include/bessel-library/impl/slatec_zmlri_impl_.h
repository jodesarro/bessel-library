/* 
    ...
    File: include/bessel-library/impl/slatec_zmlri_impl_.h
    ...
    Description:
        Slatec's ZMLRI subroutine, originally translated from Fortran to C
...
/* ----------------------------------------------------------------------- */
    ...
    d_u_2 = fkk + 1.;
    d_u_3 = tfnf + 1.;
    bk = slatec_dgamln_impl_(&d_u_1, &idum) - slatec_dgamln_impl_(&d_u_2, &idum) - slatec_dgamln_impl_(&d_u_3, &idum)
	    ;
    bk = exp(bk);
    sumr = zeror;
    sumi = zeroi;
