/*
  ...
  Description: Slatec's ZBUNK subroutine, originally translated from Fortran to
...
static inline int slatec_zbunk_impl_(double *zr, double *zi, double *fnu,
  ...
  *nz = 0;
  ...
  /* ----------------------------------------------------------------------- */
  slatec_zunk1_impl_(zr, zi, fnu, kode, mr, n, &yr[1], &yi[1], nz, tol, elim,
                     alim);
  goto L20;
L10:
  /* ----------------------------------------------------------------------- */
  ...
  /*     AND HPI=PI/2 */
  /* ----------------------------------------------------------------------- */
  slatec_zunk2_impl_(zr, zi, fnu, kode, mr, n, &yr[1], &yi[1], nz, tol, elim,
                     alim);
L20:
  return 0;
} /* slatec_zbunk_impl_ */
