...
*/
static inline tpdcomplex_impl_ cyl_h1(double nu, tpdcomplex_impl_ z) {
...
*/
static inline tpdcomplex_impl_ cyl_h1_scal(double nu,
    tpdcomplex_impl_ z) {
...
/*
    ...
    ..., nu+n-1
*/
static inline void cyl_h1_seq(double nu, unsigned int n,
...
*/
static inline void cyl_h1_scal_seq(double nu, unsigned int n,
