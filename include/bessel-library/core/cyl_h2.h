/* 
    ...
    Description:
        ...
        type for C++, cylindrical Hankel functions of the second kind, real
...
*/
static inline tpdcomplex_impl_ cyl_h2(double nu, tpdcomplex_impl_ z) {
...
*/
static inline tpdcomplex_impl_ cyl_h2_scal(double nu,
    tpdcomplex_impl_ z) {
