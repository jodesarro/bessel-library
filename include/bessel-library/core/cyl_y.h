...
*/
static inline tpdcomplex_impl_ cyl_y(double nu, tpdcomplex_impl_ z) {
...
*/
static inline tpdcomplex_impl_ cyl_y_scal(double nu,
    tpdcomplex_impl_ z) {
...
/*
    ...
    nu+1, ..., nu+n-1
*/
static inline void cyl_y_seq(double nu, unsigned int n, tpdcomplex_impl_ z,
...
*/
static inline void cyl_y_scal_seq(double nu, unsigned int n,
